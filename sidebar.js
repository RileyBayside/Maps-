...
// Lookup for park names
let parkNames = {};

// Populate parkNames from GeoJSON when loaded
function buildParkNames() {
...
// Sidebar functionality for Zones and Parks
const zones = {
...
// Zoom to park (assumes geojsonLayers defined globally)
function zoomToPark(parkId) {
  if (window.geojsonLayer) {
    window.geojsonLayer.eachLayer(function(layer) {
      if (layer.feature && layer.feature.properties && layer.feature.properties.UniqueID === parkId) {
