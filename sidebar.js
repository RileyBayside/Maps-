...
(function() {
  ...
  window.showToday = function() {
    ...
    let html = "<h2>Completed Today</h2><table border='1'><tr><th>ID</th><th>Name</th><th>Note</th><th>Time</th></tr>";
    ...
    w.document.title = "parks_2025-09-30.pdf";
    w.print();
  };
  ...
  window.exportPDF = function() {
    ...
    let html = `<h2>Park Data</h2><table border='1'>
    <tr><th>ID</th><th>Name</th><th>Done</th><th>Note</th><th>Time</th></tr>${rows}</table>`;
    let w = window.open("", "_blank");
    w.document.write(html);
    w.document.title = "parks_2025-09-30.pdf";
    w.print();
  ...
  window.exportData = function() {
    ...
    a.download = "park_data_2025-09-30.csv";
    a.click();
  };
